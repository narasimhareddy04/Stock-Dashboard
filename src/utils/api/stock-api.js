...
export const fetchHistoricalData = async (
  ...
  const url =
    "https://query1.finance.yahoo.com/v8/finance/chart/GME?period1=1682488800&period2=1716602400&interval=1d&includePrePost=true&events=div%7Csplit%7Cearn&&lang=en-US&region=US";
  console.log(url, "url");
  const response = await fetch(url);
